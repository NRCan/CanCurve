...
We suggest reading these first before moving onto the rest of the documentation.
...
Once these inputs and the buidling metadata are prepared and entered into the Buidlings Tool, the four *Curve Creation* steps can be run to create and export a DDF in :ref:`CanFlood format <sec02-CanFloodFormat>`.
